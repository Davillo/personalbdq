                    ...
                    <div class="modal-body modal-visualizar">
                         <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline" v-for="questao in filtroCheck" :key="questao.id">
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline" v-for="categoria in filtroCategoria" :key="categoria.id">
                                    <label class="form-check-label">
    ...
    export default {
        ...
        methods: {
            adicionarQuestoes(){
                ...
                .then(response => window.location.href='/avaliacao/'+window.btoa(this.dadosAvaliacao.id))
